...
import 'package:media_picker/src/constants/config.dart';
import 'package:media_picker/src/delegates/asset_picker_builder_delegate.dart';
import 'package:media_picker/src/delegates/asset_picker_delegate.dart';
import 'package:media_picker/src/provider/asset_picker_provider.dart';
import 'package:media_picker/src/widget/asset_picker_page_route.dart';

AssetPickerDelegate _pickerDelegate = const AssetPickerDelegate();

class AssetPicker<Asset, Path> extends StatefulWidget {
  const AssetPicker({required this.builder, super.key});
