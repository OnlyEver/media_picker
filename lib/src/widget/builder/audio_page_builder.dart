...
class AudioPageBuilder extends StatefulWidget {
  const AudioPageBuilder({required this.asset, super.key});
...
class _AudioPageBuilderState extends State<AudioPageBuilder> {
  ...
  Widget get durationIndicator {
    final durationBuilder = Singleton.textDelegate.durationIndicatorBuilder;
    final semanticsDurationBuilder =
