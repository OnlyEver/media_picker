...
// ignore_for_file: use_build_context_synchronously, parameter_assignments

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:media_picker/picker_library/src/themes.dart';
...
class AssetPickerDelegate {
  ...
  Future<List<AssetEntity>?> pickAssets(
    ...
    final ps = await permissionCheck(
      requestOption: permissionRequestOption,
    );
    final route = pageRouteBuilder?.call(const SizedBox.shrink()) ??
