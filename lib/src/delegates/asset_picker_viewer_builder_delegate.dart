...
// ignore_for_file: prefer_asserts_with_message, use_build_context_synchronously
...
import 'package:media_picker/src/constants/custom_scroll_physics.dart';
import 'package:media_picker/src/internals/singleton.dart';
import 'package:media_picker/src/widget/builder/audio_page_builder.dart';
import 'package:media_picker/src/widget/builder/fade_image_builder.dart';
import 'package:media_picker/src/widget/builder/image_page_builder.dart';
import 'package:media_picker/src/widget/builder/video_page_builder.dart';
...
abstract class AssetPickerViewerBuilderDelegate<Asset, Path> {
  ...
  /// 底栏预览部件的高度
  double get bottomPreviewHeight => 90;
  ...
  void updateAnimation(ExtendedImageGestureState state) {
    ...
    final end = state.gestureDetails!.totalScale! == 1.0 ? 3.0 : 1.0;
...
class DefaultAssetPickerViewerBuilderDelegate
  ...
  Widget bottomDetailItemBuilder(BuildContext context, int index) {
    ...
    void onTap(AssetEntity asset) {
      ...
      final offset = (index - 0.5) * (bottomPreviewHeight - padding * 3) -
        ...
        child: StreamBuilder<int>(
          ...
          builder: (_, AsyncSnapshot<int> snapshot) {
            ...
            final viewingIndex = shouldReversePreview
                ...
                : snapshot.data!;
            final isViewing = previewAssets[viewingIndex] == asset;
            final item = switch (asset.type) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: const Center(child: Icon(Icons.check, size: 20)),
        ),
      ),
    );
  }
  ...
  Widget selectButton(BuildContext context) {
    return CNP<AssetPickerViewerProvider<AssetEntity>>.value(
      ...
      builder: (_, Widget? w) => StreamBuilder<int>(
        ...
        stream: pageStreamController.stream,
        builder: (_, s) {
          final asset = previewAssets.elementAt(s.data!);
